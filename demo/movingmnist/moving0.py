...
class Moving0(ltn.LightningModule):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(80, 80, kernel_size=1, padding=0)
        self.lnon3 = LNon(steps=1, length=1, points=120)
        self.conv4 = nn.Conv2d(80, 80, kernel_size=1, padding=0)
        self.lnon4 = LNon(steps=1, length=1, points=120)
        self.conv5 = nn.Conv2d(80, 80, kernel_size=1, padding=0)
        self.lnon5 = LNon(steps=1, length=1, points=120)
        self.conv6 = nn.Conv2d(80, 80, kernel_size=1, padding=0)
        self.lnon6 = LNon(steps=1, length=1, points=120)

        self.conv7 = nn.Conv2d(160, 80, kernel_size=1, padding=0)
        self.lnon7 = LNon(steps=1, length=1, points=120)
        self.conv8 = nn.Conv2d(160, 80, kernel_size=1, padding=0)
        self.lnon8 = LNon(steps=1, length=1, points=120)
        self.conv9 = nn.Conv2d(160, 80, kernel_size=1, padding=0)
        self.lnon9 = LNon(steps=1, length=1, points=120)
        self.conva = nn.Conv2d(160, 40, kernel_size=1, padding=0)
        self.lnona = LNon(steps=1, length=1, points=120)
        self.convb = nn.Conv2d(80, 20, kernel_size=1, padding=0)
        self.lnonb = LNon(steps=1, length=1, points=120)
        self.convc = nn.Conv2d(40, 10, kernel_size=1, padding=0)
        self.lnonc = LNon(steps=1, length=1, points=120)
