...
class Fashion6(pl.LightningModule):
    def __init__(self, learning_rate=1e-3):
        ...
        self.conv5 = nn.Conv2d(270 + 810, 360, kernel_size=3, padding=1)
        self.conv6 = nn.Conv2d(90 + 360, 150, kernel_size=3, padding=1)
        self.conv7 = nn.Conv2d(30 + 150, 60, kernel_size=3, padding=1)
        self.conv8 = nn.Conv2d(60, 1, kernel_size=3, padding=1)

        self.flat = Reshape(810)
        self.mlp = MLP(810, [10])
