...
class Fashion0(MNISTModel):
    def __init__(self):
        ...
        self.lnon0 = LNon(steps=1, length=1, points=2048)
        self.conv1 = nn.Conv2d(10, 10, kernel_size=7, padding=3)
        self.conv2 = nn.Conv2d(10, 30, kernel_size=3, padding=1)
        self.lnon1 = LNon(steps=1, length=1, points=2048)
        self.conv3 = nn.Conv2d(30, 30, kernel_size=3, padding=1)
        self.conv4 = nn.Conv2d(30, 90, kernel_size=3, padding=1)
        self.lnon2 = LNon(steps=1, length=1, points=2048)
        self.conv5 = nn.Conv2d(90, 90, kernel_size=3, padding=1)
        self.conv6 = nn.Conv2d(90, 270, kernel_size=3, padding=1)
        self.lnon3 = LNon(steps=1, length=1, points=2048)
        self.conv6 = nn.Conv2d(270, 270, kernel_size=3, padding=1)
