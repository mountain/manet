...
class Fashion0(MNISTModel):
    def __init__(self):
        ...
        self.lnon01 = LNon(steps=2, length=1, points=120)
        self.lnon02 = LNon(steps=2, length=1, points=120)
        self.conv1 = nn.Conv2d(5, 15, kernel_size=3, padding=1)
        self.lnon1 = LNon(steps=2, length=1, points=120)
        self.lnon11 = LNon(steps=2, length=1, points=120)
        self.lnon12 = LNon(steps=2, length=1, points=120)
        self.conv2 = nn.Conv2d(15, 45, kernel_size=3, padding=1)
        self.lnon2 = LNon(steps=2, length=1, points=120)
        self.lnon21 = LNon(steps=2, length=1, points=120)
        self.lnon22 = LNon(steps=2, length=1, points=120)
        self.conv3 = nn.Conv2d(45, 135, kernel_size=3, padding=1)
        self.lnon3 = LNon(steps=2, length=1, points=120)
        self.lnon31 = LNon(steps=2, length=1, points=120)
        self.lnon32 = LNon(steps=2, length=1, points=120)
