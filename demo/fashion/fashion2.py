...
class Fashion2(pl.LightningModule):
    def __init__(self, learning_rate=1e-3):
        ...
        self.recognizer = nn.Sequential(
            nn.Conv2d(1, 40, kernel_size=7, padding=3),
            MLP(1, [1], mac_points=5, mac_steps=3, mac_unit=MacSplineUnit),
            Reshape(40, 28, 28),
            nn.MaxPool2d(2),
            ...
            MLP(1, [1], mac_points=5, mac_steps=3, mac_unit=MacSplineUnit),
            Reshape(320, 3, 3),
            MLP(320 * 9, [320 * 4, 320, 10], mac_points=5, mac_steps=3, mac_unit=MacSplineUnit),
            Reshape(10),
            nn.LogSoftmax(dim=1)
        )
