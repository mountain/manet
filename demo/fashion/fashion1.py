...
from manet.mac import MLP, Reshape, MacSplineUnit
...
class Fashion1(pl.LightningModule):
    def __init__(self, learning_rate=1e-3):
        ...
        self.recognizer = nn.Sequential(
            ...
            MLP(1, [1], mac_steps=3, mac_points=5, mac_length=1, mac_unit=MacSplineUnit),
            Reshape(5, 28, 28),
            nn.MaxPool2d(2),
            ...
            MLP(1, [1], mac_steps=3, mac_points=5, mac_length=1, mac_unit=MacSplineUnit),
            Reshape(135 * 3 * 3),
            MLP(135 * 9, [10], mac_steps=3, mac_points=5, mac_length=1, mac_unit=MacSplineUnit),
            Reshape(10),
            nn.LogSoftmax(dim=1)
        )
