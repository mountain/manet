...
class FashionA(MNISTModel):
    def __init__(self):
        ...
        self.nmlp0 = MLP(1, [1], steps=2, length=1, points=5)
        self.nshp0 = Reshape(5, 28, 28)
        ...
        self.conv3 = nn.Conv2d(5, 15, kernel_size=3, padding=1)
        self.nmlp3 = MLP(1, [1], steps=2, length=1, points=5)
        self.nshp3 = Reshape(15, 14, 14)
        self.conv4 = nn.Conv2d(15, 15, kernel_size=3, padding=1)
        ...
        self.conv5 = nn.Conv2d(15, 45, kernel_size=3, padding=1)
        ...
        self.conv7 = nn.Conv2d(45, 135, kernel_size=3, padding=1)
        ...
        self.avpl0 = nn.AvgPool2d(2)

        self.nmlp9 = MLP(135, [10], steps=2, length=1, points=5)
        self.shap9 = Reshape(10)
