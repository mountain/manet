...
class MNModel9(pl.LightningModule):
    def __init__(self, learning_rate=1e-3):
        ...
        self.learnable_function0 = LogisticFunction(p=2.0, debug_key='lf0')
        self.learnable_function1 = LogisticFunction(p=2.0, debug_key='lf1')
        self.learnable_function2 = LogisticFunction(p=2.0, debug_key='lf2')
        self.learnable_function3 = LogisticFunction(p=2.0, debug_key='lf3')
