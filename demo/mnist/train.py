...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(mnist_train, shuffle=True, batch_size=opt.batch, num_workers=16)
    val_loader = DataLoader(mnist_val, batch_size=opt.batch, num_workers=16)
    test_loader = DataLoader(mnist_val, batch_size=opt.batch, num_workers=16)
