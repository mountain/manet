...
from manet.aeg import SplineFunction
from manet.mac import Reshape


class MNModel9(pl.LightningModule):
    def __init__(self, learning_rate=1e-3):
        ...
        self.learnable_function0 = SplineFunction(debug_key='lf0')
        self.learnable_function1 = SplineFunction(debug_key='lf1')
        self.learnable_function2 = SplineFunction(debug_key='lf2')
        self.learnable_function3 = SplineFunction(debug_key='lf3')
